...
export default function BlogPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-10">
            <h1 className="text-4xl font-bold text-center text-blue-200">Blog de Salud y Ejercicio</h1>
            ...
            <form onSubmit={handleCreateBlog} className="bg-white p-6 rounded-lg shadow space-y-4">
                <h2 className="text-2xl font-semibold text-gray-700">Crear nuevo blog</h2>
                <input
                    type="text"
                    value={topic}
            ...
            {loading ? (
                ...
                blogs.map((blog) => (
                    <div key={blog.id} className="bg-white p-6 rounded-lg shadow space-y-2">

...
const Servicios = () => {
  return (
    ...
    >
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-10 mx-24">
        {/* Tarjeta 1 */}
        <div className="bg-[#FAFAE7] rounded-3xl shadow-md p-8 flex flex-col items-center text-center transition-transform duration-300 ease-in-out hover:scale-[1.03]">
          <Image
            src="/registro.svg"
